...
Canvas2dRe.setStrokeStyle(ctx, /* String */Block.__(0, ["red"]));

Canvas2dRe.setFillStyle(ctx, /* String */Block.__(0, ["red"]));

var match = Canvas2dRe.fillStyle(ctx);

if (match.tag) {
  match[0].addColorStop(0.0, "red");
}

var match$1 = Canvas2dRe.strokeStyle(ctx);

if (match$1.tag) {
  match$1[0].addColorStop(1.2, "blue");
} else {
...
Canvas2dRe.setStrokeStyle(ctx, /* Gradient */Block.__(1, [linearGradient]));
