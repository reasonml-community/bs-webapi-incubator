...
var Canvas2dRe = require("../../src/canvas/Canvas2dRe.js");
...
((function (eta) {
        var param = undefined;
        var param$1 = eta;
        param$1.fillText("hi", 1, 0, param !== undefined ? Js_primitive.valFromOption(param) : undefined);
        return /* () */0;
      })(ctx));
...
((function (eta) {
        var param = undefined;
        var param$1 = eta;
        param$1.strokeText("hi", 1, 0, param !== undefined ? Js_primitive.valFromOption(param) : undefined);
        return /* () */0;
      })(ctx));
