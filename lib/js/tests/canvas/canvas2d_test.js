...
var Canvas2dRe$Webapi = require("../../src/canvas/Canvas2dRe.js");
...
ctx.globalCompositeOperation = Canvas2dRe$Webapi.Composite[/* sourceOver */0];

ctx.lineWidth = 1;

ctx.lineCap = Canvas2dRe$Webapi.LineCap[/* butt */0];

ctx.lineJoin = Canvas2dRe$Webapi.LineJoin[/* round */0];

ctx.miterLimit = 10;

Canvas2dRe$Webapi.setStrokeStyle(ctx, /* String */0, "red");

Canvas2dRe$Webapi.setFillStyle(ctx, /* String */0, "red");

var match = Canvas2dRe$Webapi.fillStyle(ctx);
...
var match$1 = Canvas2dRe$Webapi.strokeStyle(ctx);
...
Canvas2dRe$Webapi.setStrokeStyle(ctx, /* Gradient */1, linearGradient);
