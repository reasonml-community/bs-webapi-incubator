...
ElementRe$Webapi.insertAdjacentElement(/* BeforeBegin */0, el2, el);

ElementRe$Webapi.insertAdjacentHTML(/* AfterBegin */1, "<strong>text</strong>", el);

ElementRe$Webapi.insertAdjacentText(/* AfterEnd */3, "text", el);
