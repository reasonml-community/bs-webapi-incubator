...
function unNull(definitelyNotNull) {
  if (definitelyNotNull !== null) {
    ...
    throw [
          ...
          [
            "/home/glennsl/projects.local/reason-js/tests/test.re",
            7,
            14
          ]
        ];
...
var el = unNull(document.getElementById("some-element"));

var el2 = unNull(document.getElementById("some-other-element"));
...
document.importNode(el, Js_boolean.to_js_boolean(/* true */1));
...
document.execCommand("copy", Js_boolean.to_js_boolean(/* false */0), null);
...
document.queryCommandIndeterm("cut");
...
var p = ReasonJs.fetch("/greatings");
