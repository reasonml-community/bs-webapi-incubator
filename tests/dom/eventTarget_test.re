...
EventTarget.addEventListenerUseCapture "click" handleClick (Js.Boolean.to_js_boolean true) target;
...
EventTarget.removeEventListenerUseCapture "click" handleClick (Js.Boolean.to_js_boolean true) target;
