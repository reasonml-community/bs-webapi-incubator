...
let _ = dataset el;
let _ = dir el;
let _ = setDir el DomRe.Rtl;
let _ = draggable el;
let _ = setDraggable el Js.true_;
let _ = dropzone el;
let _ = hidden el;
let _ = setHidden el Js.true_;
let _ = itemScope el;
let _ = setItemScope el Js.true_;
let _ = itemType el;
let _ = itemId el;
...
let _ = spellcheck el;
let _ = setSpellcheck el Js.true_;
let _ = style el;
...
let _ = translate el;
let _ = setTranslate el Js.true_;
