...
Window.blur window;
let idleId = Window.requestIdleCallback (fun _ => ()) window; /* out of order */
...
Window.postMessage "my message" "*" window;
/*Window.postMessageWithTransfers "my message" "*" transfers window;*/ /* Currently no way to make transferables */
Window.print window;
...
let _ = Window.requestIdleCallbackWithOptions (fun _ => ()) { "timeout": 1000 } window;
