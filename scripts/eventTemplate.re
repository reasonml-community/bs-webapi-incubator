...
{j|
  ...
  [@bs.send.pipe : T.t] external add$(name)EventListenerWithOptions : ([@bs.as "$(lname)"] _, Dom.$(typ) => unit, {. "capture": Js.boolean, "once": Js.boolean, "passive": Js.boolean}) => unit = "addEventListener"; /* not widely supported */
  ...
  [@bs.send.pipe : T.t] external remove$(name)EventListenerWithOptions : ([@bs.as "$(lname)"] _, Dom.$(typ) => unit, {. "capture": Js.boolean, "passive": Js.boolean}) => unit = "removeEventListener"; /* not widely supported */
