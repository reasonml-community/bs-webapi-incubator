...
[@bs.send] external bufferData : (glT, int, Js.Typed_array.Uint16Array.t, int) => unit =
  "bufferData";

[@bs.send] external bufferFloatData : (glT, int, Js.Typed_array.Float32Array.t, int) => unit =
  "bufferData";
...
[@bs.send] external bindAttribLocation : (glT, programT, int, string) => unit =
  "bindAttribLocation";
...
[@bs.send] external vertexAttribPointer : (glT, int, int, int, Js.boolean, int, int) => unit =
  "vertexAttribPointer";
