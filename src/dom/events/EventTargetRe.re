module Impl = (T: {type t;}) => {
  ...
  [@bs.send.pipe : T.t] external addEventListenerWithOptions : (string, Dom.event => unit, {. "capture": Js.boolean, "once": Js.boolean, "passive": Js.boolean}) => unit =
  ...
  [@bs.send.pipe : T.t] external removeEventListenerWithOptions : (string, Dom.event => unit, {. "capture": Js.boolean, "passive": Js.boolean}) => unit =
