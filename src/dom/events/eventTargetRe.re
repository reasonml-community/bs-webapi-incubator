module Impl (T: { type t; }) => {
  ...
  /*let addEventListenerUseCapture : string => (DomTypesRe.event => unit) => T.t => unit = fun type_ listener self => addEventListenerUseCapture type_ listener Js.true_ self;*/ /* temporarily removed to reduce code size */
  ...
  /*let removeEventListenerUseCapture : string => (DomTypesRe.event => unit) => T.t => unit = fun type_ listener self => removeEventListenerUseCapture type_ listener Js.true_ self;*/ /* temporarily removed to reduce code size */
