...
module Impl = (T: {type t;}) => {
  ...
  external attachShadowClosed :
    ...
    "attachShadow"; /* experimental */
  [@bs.send.pipe : T.t]
  external animate : (Js.t({..}), Js.t({..})) => Dom.animation =
    ""; /* experimental */
  [@bs.send.pipe : T.t] external closest : string => Dom.element = ""; /* experimental */
  [@bs.send.pipe : T.t]
  external createShadowRoot : Dom.shadowRoot =
  ...
  [@bs.send.pipe : T.t]
  external hasAttributeNS : (string, string) => bool = "";
  ...
  let insertAdjacentElement:
    (DomTypesRe.insertPosition, Dom.element_like('a), T.t) => unit =
    (position, element, self) =>
      insertAdjacentElement(
        DomTypesRe.encodeInsertPosition(position),
        element,
        self
      );
  [@bs.send.pipe : T.t]
  ...
  [@bs.send.pipe : T.t]
  external removeAttributeNS : (string, string) => unit = "";
  ...
  [@bs.send.pipe : T.t]
  external setPointerCapture : Dom.eventPointerId => unit = "";
