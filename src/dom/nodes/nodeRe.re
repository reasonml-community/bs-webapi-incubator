module Impl (T: { type t; }) => {
  ...
  external asNode : T.t => DomTypesRe.node = "%identity";
  */
  ...
  let setNodeValue : T.t => option string => unit = fun self value => setNodeValue self (Js.Null.from_opt value);
  /* outerText */
  ...
  let cloneNodeDeep : T.t => DomTypesRe.node = fun self => cloneNodeDeep Js.true_ self;
  ...
  let getRootNodeComposed : T.t => DomTypesRe.node = fun self => getRootNodeComposed Js.true_ self;
  ...
  let lookupNamespaceURI: option string => T.t => option string = fun prefix self => lookupNamespaceURI (Js.Null.from_opt prefix) self;
