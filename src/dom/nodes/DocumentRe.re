module Impl = (T: {type t;}) => {
  ...
  [@deprecated
    "Will fail if no doctype is defined, consider using usnafeAsHtmlDocument instead"
  ]
  ...
  [@bs.get]
  external compatMode : T.t => string /* compatMode enum */ =
    ""; /* experimental */
  ...
  [@bs.get]
  external styleSheets : T.t => array(Dom.cssStyleSheet) =
  ...
  external createNodeIteratorWithWhatToShowFilter :
    (Dom.node_like('a), DomTypesRe.WhatToShow.t, Dom.nodeFilter) =>
    Dom.nodeIterator =
  ...
  external createTreeWalkerWithWhatToShowFilter :
    (Dom.element_like('a), DomTypesRe.WhatToShow.t, Dom.nodeFilter) =>
    Dom.treeWalker =
    "createTreeWalker";
  [@bs.send.pipe : T.t]
  external elementFromPoint : (int, int) => Dom.element =
  ...
  [@bs.send.pipe : T.t]
  external getAnimations : array(Dom.animation) = ""; /* experimental */
  [@bs.send.pipe : T.t]
