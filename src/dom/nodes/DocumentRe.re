module Impl = (T: {type t;}) => {
  ...
  [@bs.get] [@bs.return null_to_opt] external pointerLockElement : T.t => option(Dom.element) =
  ""; /* experimental */
  ...
  [@bs.get] external styleSheets : T.t => array(Dom.cssStyleSheet) =
  ""; /* return StyleSheetList, not array */
  ...
  [@bs.send.pipe : T.t] external createElementWithOptions : (string, Js.t({..})) => Dom.element =
  "createElement"; /* not widely supported */
  [@bs.send.pipe : T.t] external createElementNS : (string, string) => Dom.element = "";
  [@bs.send.pipe : T.t] external createElementNSWithOptions : (string, string, Js.t({..})) => Dom.element =
  "createEementNS"; /* not widely supported */
  [@bs.send.pipe : T.t] external createEvent : string /* large enum */ => Dom.event =
  ...
  external createNodeIteratorWithWhatToShow :
    (Dom.node_like('a), DomTypesRe.WhatToShow.t) => Dom.nodeIterator =
    "createNodeIterator";
  [@bs.send.pipe : T.t]
  external createNodeIteratorWithWhatToShowFilter :
    (Dom.node_like('a), DomTypesRe.WhatToShow.t, Dom.nodeFilter) => Dom.nodeIterator =
    "createNodeIterator";
  ...
  external createTreeWalkerWithWhatToShow :
    (Dom.element_like('a), DomTypesRe.WhatToShow.t) => Dom.treeWalker =
    "createTreeWalker";
  [@bs.send.pipe : T.t]
  external createTreeWalkerWithWhatToShowFilter :
    (Dom.element_like('a), DomTypesRe.WhatToShow.t, Dom.nodeFilter) => Dom.treeWalker =
    "createTreeWalker";
  [@bs.send.pipe : T.t] external elementFromPoint : (int, int) => Dom.element =
  ""; /* experimental, but widely supported */
  [@bs.send.pipe : T.t] external elementsFromPoint : (int, int) => array(Dom.element) =
  ""; /* experimental */
  ...
  external importNodeDeep :
    (Dom.element_like('a), [@bs.as {json|true|json}] _) => Dom.element_like('a) =
    "importNode";
  [@bs.send.pipe : T.t] external registerElement : (string, unit) => Dom.element =
  ""; /* experimental and deprecated in favor of customElements.define() */
  [@bs.send.pipe : T.t] external registerElementWithOptions : (string, Js.t({..}), unit) => Dom.element =
