...
external setStart : DomRe.node => int => unit = "" [@@bs.send.pipe: t];
external setEnd : DomRe.node => int => unit = "" [@@bs.send.pipe: t];
external setStartBefore : DomRe.node => unit = "" [@@bs.send.pipe: t];
external setStartAfter : DomRe.node => unit = "" [@@bs.send.pipe: t];
external setEndBefore : DomRe.node => unit = "" [@@bs.send.pipe: t];
external setEndAfter : DomRe.node => unit = "" [@@bs.send.pipe: t];
external selectNode : DomRe.node => unit = "" [@@bs.send.pipe: t];
external selectNodeContents : DomRe.node => unit = "" [@@bs.send.pipe: t];
...
external insertNode : DomRe.node => unit = "" [@@bs.send.pipe: t];
external surroundContents : DomRe.node => unit = "" [@@bs.send.pipe: t];
...
external comparePoint : DomRe.node => int => int /* compareRsult enum */ = "" [@@bs.send.pipe: t];
let comparePoint : DomRe.node => int => t => compareResult = fun node offset self => decodeCompareResult (comparePoint node offset self);
...
external intersectsNode : DomRe.node => Js.boolean = "" [@@bs.send.pipe: t];
let intersectsNode : DomRe.node => t => bool = fun node self => Js.to_bool (intersectsNode node self);
external isPointInRange : DomRe.node => int => Js.boolean = "" [@@bs.send.pipe: t];
let isPointInRange : DomRe.node => int => t => bool = fun node offset self => Js.to_bool (isPointInRange node offset self);
