module Impl = (T: {type t;}) => {
  ...
  [@bs.set] external setContentEditable : (t_htmlElement, string /* enum */) => unit =
    "contentEditable";
  ...
  [@bs.get] external contextMenu : t_htmlElement => Dom.htmlElement =
  ""; /* returns HTMLMenuElement */
  [@bs.set] external setContextMenu : (t_htmlElement, Dom.htmlElement) => unit =
  ...
  [@bs.set] external setDraggable : (t_htmlElement, Js.boolean) => unit =
  ...
  [@bs.set] external setHidden : (t_htmlElement, Js.boolean) => unit =
  ...
  [@bs.set] external setItemScope : (t_htmlElement, Js.boolean) => unit =
  "itemScope" /* experimental */ /* temproarily removed to reduce codegen size */; /*let setItemScope : t_htmlElement => bool => unit = fun self value => setItemScope self (Js.Boolean.to_js_boolean value);*/
  ...
  [@bs.set] external setItemValue : (t_htmlElement, Js.t({..})) => unit =
  ...
  [@bs.set] external setSpellcheck : (t_htmlElement, Js.boolean) => unit =
  ...
  [@bs.set] external setTranslate : (t_htmlElement, Js.boolean) => unit =
