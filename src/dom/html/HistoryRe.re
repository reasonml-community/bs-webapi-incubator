...
[@bs.set] external setScrollRestoration : (t, Js.boolean) => unit = "scrollRestoration"; /* experimental */
let setScrollRestoration: (t, bool) => unit =
  (self, value) => setScrollRestoration(self, Js.Boolean.to_js_boolean(value));
