module Impl = (T: {type t;}) => {
  ...
  [@bs.get] [@bs.return nullable] external body : t_htmlDocument => option(Dom.element) =
  ...
  let dir: t_htmlDocument => DomTypesRe.dir =
