...
external containsNode : DomTypesRe.node_like _ => Js.boolean => bool= "" [@@bs.send.pipe: t];
let containsNode : DomTypesRe.node_like _ => bool => t => bool = fun node partlyContained self => containsNode node (Js.Boolean.to_js_boolean partlyContained) self;
